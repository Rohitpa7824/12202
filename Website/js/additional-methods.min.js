...
!function (t) {
    ...
    return function () {
        ...
        var i, n, r = "string" == typeof d ? d.replace(/\s/g, "") : "image/*", o = this.optional(a);
        if (o) return o;
        if ("file" === t(a).attr("type") && (r = r.replace(/[\-\[\]\/\{\}\(\)\+\?\.\\\^\$\|]/g, "\\$&").replace(/,/g, "|").replace(/\/\*/g, "/.*"), a.files && a.files.length)) for (n = new RegExp(".?(" + r + ")$", "i"), i = 0; i < a.files.length; i++) if (!a.files[i].type.match(n)) return !1;
        return !0
        ...
        "use strict";
        if (this.optional(e)) return !0;
        var a, d, i, n, r = new RegExp(/^([ABCDEFGHJKLMNPQRSUVW])(\d{7})([0-9A-J])$/gi), o = t.substring(0, 1),
            s = t.substring(1, 8), l = t.substring(8, 9), u = 0, c = 0, h = 0;
    ...
    }, "Please specify a valid NIP number."), t.validator.addMethod("notEqualTo", function (e, a, d) {
        ...
        var i = t(d[1], a.form), n = i.eq(0),
            r = n.data("valid_req_grp") ? n.data("valid_req_grp") : t.extend({}, this), o = i.filter(function () {
        ...
        var i = t(d[1], a.form), n = i.eq(0), r = n.data("valid_skip") ? n.data("valid_skip") : t.extend({}, this),
            o = i.filter(function () {
                return r.elementValue(this)
            }).length, s = 0 === o || o >= d[0];
        ...
        var d, i = void 0 === a, n = !i && void 0 !== a.caseSensitive && a.caseSensitive,
        ...
        var e, a, d, i, n, r,
            ...
            l = [8, 7, 6, 5, 4, 3, 2, 10, 0, 9, 8, 7, 6, 5, 4, 3, 2], u = 0;
        for (e = 0; e < 17; e++) {
            if (i = l[e], d = t.slice(e, e + 1), 8 === e && (r = d), isNaN(d)) {
                for (a = 0; a < o.length; a++) if (d.toUpperCase() === o[a]) {
